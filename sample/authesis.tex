...
%        inner=0.75in,
%        }
\usepackage{ragged2e}  % allows the justify environment
...
\begin{center}
 \LARGE
 \hspace*{}% adjust this value as needed
 \textbf{\uppercase{ INTELLIGENT AUTOSCALER FOR MICROSERVICES
}}
 \hspace{-3 cm}\\
 ...
 \vspace{0.4\baselineskip}
  ...
  {
  \Large \textbf{KATHIRAVAN M}}\\
  \normalsize{\textbf{(2024178033)}}\\
    \vspace{0.2\baselineskip}
...
\end{center}
  ...
  \vspace{15px}
   ...
   \includegraphics[scale=0.9]{auemblem.pdf} \\
...
\begin{spacing}{1.5}
  \begin{sloppypar}
  \fontsize{13}{14.5}\selectfont Certified that this project report titled \textbf{INTELLIGENT AUTOSCALING FOR MICROSERVICES} is the bona fide work of \textbf{KATHIRAVAN M} who carried out project work under my supervision. Certified further that to the best of my knowledge and belief, the work reported herein does not form part of any other thesis or dissertation on the basis of which a degree or an award was conferred on an earlier occasion on this or any other candidate.
  \end{sloppypar}
\end{spacing}
\vspace{0.3 cm}
\begin{flushleft}
 \parbox[t]{6 cm}{\small{\textbf{PLACE: CHENNAI}}\\
 \small{\textbf{DATE: }}}
 \hfill
 \parbox[t]{6 cm}{
 \raggedleft
 \small{\textbf{MRS. N. ANBARASI}} \\
 \small{\textbf{TEACHING FELLOW}}\\
...
%\include{Abstract/Abs_tamil}
\cleardoublepage
\phantomsection
\addcontentsline{toc}{section}{\bfseries{ABSTRACT TAMIL}} % or {section} if your ToC uses sections
\includepdf[pages=-,pagecommand={}]{tamil-abstract-final.pdf}
%\include{Abstract_tamil/Abs_tamil}
\include{acknowl}
